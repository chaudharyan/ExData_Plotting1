...
# Setting parameters to display multiple plots in one graph
    par(mfcol =c(2,2))

#Graph 1
    plot(f$DateTime, f$Global_active_power, type="l", xlab="", ylab="Global Active Power(kilowatts)")

# Graph 2 -second row-first column
    ...
    # Add data series with different colors
...
#Graph 3 -second column-first row

    plot(f$DateTime, f$Voltage, type="l", xlab="datetime", ylab="Voltage")

# Graph 4 -second column-second row
